            ...
            <div class="h-100" style="background: linear-gradient(45deg, rgba(0, 255, 255, 0.2), rgba(255, 255, 255, 0.2), rgba(152, 255, 152, 0.2));">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= base_url('admin') ?>" class="sidebar-link"><i class="fa-solid fa-home pe-2"></i>Overview</a>
                    </li>
                    <li class="sidebar-item">
                        <a href="<?= base_url('databukuu') ?>" class="sidebar-link collapsed" data-bs-target="#pages"
                            aria-expanded="false"><i class="fa-solid fa-ticket pe-2"></i>
                            Data Buku
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="<?= base_url('datapeminjamen') ?>" class="sidebar-link collapsed" data-bs-target="#auth" 
